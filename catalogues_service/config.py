...
class Config:
    ...
    # Database
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'mysql+pymysql://root:@localhost:3306/catalogues_service_db'
    ...
    BASE_URL = os.environ.get('BASE_URL') or f'http://localhost:{os.environ.get("PORT", 8002)}'
